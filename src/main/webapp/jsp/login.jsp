...
<head>
    ...
    <script>
        $(function () {
            ...
            //验证码
            $("#captImage").click(function () {
                $("#captImage").prop("src", "${app}/validataImageCode/imageCode?time=" + new Date().getTime())
            });
            ...
            $("#loginButtonId").click(function () {
                ...
                if ($("#form-username").val() == '') {
                    ...
                    $("#error").append("密码不能为空");
                } else if ($("#form-code").val() == '') {
                    $("#error").append("验证码不能为空");
                } else {
                    $.ajax({
                        url: "${app}/admin/login",
                        data: "username=" + $("#form-username").val() + "&password=" + $("#form-password").val() + "&enCode=" + $("#form-code").val() + "",
                        success: function (data) {
                            if (data == "aaa") {
                                window.location.href = '${app}/jsp/home.jsp';
                            } else {
                                $("#error").append(data)
                            }
                        }
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        ...
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                <img id="captImage" style="height: 48px" class="captchaImage"
                                     src="${app}/validataImageCode/imageCode">
